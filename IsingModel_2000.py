...
for cyc_1 in range(step):
    ...
    if cyc_1 == 0:
        np.savetxt("./simulator/2000/lattice_50.text",lat,fmt="%d")
 
    
    if cyc_1 == 12:
        np.savetxt("./simulator/2000/lattice_38.text",lat,fmt="%d")

 
    if cyc_1 == 23:
        np.savetxt("./simulator/2000/lattice_27.text",lat,fmt="%d")


 
    if cyc_1 == 34:
        np.savetxt("./simulator/2000/lattice_16.text",lat,fmt="%d")

 
    if cyc_1 == 45:
        np.savetxt("./simulator/2000/lattice_05.text",lat,fmt="%d")
...
np.savetxt("./simulator/2000/heat_capa_result.text",Heat_Capacity,fmt="%.4f")
np.savetxt("./simulator/2000/magn_susc_result.text",Magnetic_Susceptability,fmt="%.4f")
np.savetxt("./simulator/2000/E_avg_result.text",E_avg,fmt="%.4f")
