...
for cyc_1 in range(step):
    ...
    if cyc_1 == 0:
        np.savetxt("/Users/imac/Desktop/github/2DIsingModelSimulation/Statistic/lattice_50.text",lat,fmt="%d")
 
    
    if cyc_1 == 12:
        np.savetxt("/Users/imac/Desktop/github/2DIsingModelSimulation/Statistic/lattice_38.text",lat,fmt="%d")

 
    if cyc_1 == 23:
        np.savetxt("/Users/imac/Desktop/github/2DIsingModelSimulation/Statistic/lattice_27.text",lat,fmt="%d")


 
    if cyc_1 == 34:
        np.savetxt("/Users/imac/Desktop/github/2DIsingModelSimulation/Statistic/lattice_16.text",lat,fmt="%d")

 
    if cyc_1 == 45:
        np.savetxt("/Users/imac/Desktop/github/2DIsingModelSimulation/Statistic/lattice_05.text",lat,fmt="%d")
...
plt.figure()
plt.plot(Temp,E_avg,'bo-')
plt.savefig("/Users/imac/Desktop/github/2DIsingModelSimulation/Statistic/E_avg.png")

plt.figure()
plt.plot(Temp,Heat_Capacity,'bo-')
plt.savefig("/Users/imac/Desktop/github/2DIsingModelSimulation/Statistic/Heat_Capacity.png")

plt.figure()
plt.plot(Temp,Magnetic_Susceptability,'bo-')
plt.savefig("/Users/imac/Desktop/github/2DIsingModelSimulation/Statistic/Magnetic_Susceptability.png")

np.savetxt("/Users/imac/Desktop/github/2DIsingModelSimulation/Statistic/heat_capa_result.text",Heat_Capacity,fmt="%.4f")
np.savetxt("/Users/imac/Desktop/github/2DIsingModelSimulation/Statistic/magn_susc_result.text",Magnetic_Susceptability,fmt="%.4f")
np.savetxt("/Users/imac/Desktop/github/2DIsingModelSimulation/Statistic/E_avg_result.text",E_avg,fmt="%.4f")
